...
export function MainLayout(
  ...
  const [isUserPannelOpen, { open: openUserModal, close: closeUserModal }] =
    useDisclosure(false)
  ...
  const ProjectMenu = React.useCallback(() => {
    return (
      <Menu>
        <Menu.Target>
          <Button size="xs" variant={'light'} rightIcon={<AiOutlineDown />}>
            {props.project.title}
          </Button>
        </Menu.Target>
        <Menu.Dropdown>
          ...
          <Stack>
            ...
            <Stack spacing={8}>
              ...
              <TextInput
                ...
                {...userSettingsForm.register('notificationEmail')}
                size="sm"
              />
              <Switch
                defaultChecked={props.userInfo.enableNewCommentNotification}
                onChange={(e) => {
            ...
            <Stack spacing={8}>
              ...
              <TextInput
                ...
                {...userSettingsForm.register('displayName')}
                size="sm"
              />
            </Stack>
                    ...
                    <Grid.Col span={6}>
                      ...
                      >
                        <Stack>
                          ...
                          props.subscription.status === 'cancelled' ? (
                            ...
                            <Button
                              size="xs"
                              variant={'outline'}
                              loading={downgradePlanMutation.isLoading}
                              onClick={(_) => {
                                if (
                                  window.confirm('Are you sure to downgrade?')
                                ) {
            ...
            <Button
              ...
              onClick={onClickSaveUserSettings}
            >
              Save
            </Button>
